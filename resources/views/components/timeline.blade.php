...
#progress-bar-container li.active:before, #progress-bar-container li:hover:before {
	...
	background: linear-gradient(to right, #486DFF 0%,#fff 100%); 
}
...
#progress-bar-container #line-progress {
	...
	height:100%;
	background: #207893;	 
	background: linear-gradient(to right, #486DFF 0%,#2ea3b7 100%); 
	position:absolute;
	z-index:2;
	border-radius:50px;
	transition:all ease 0.9s;
...
<body>
    <h1 class="text-white text-center font-bold text-2xl">TIMELINE</h1>
    <div class="process-wrapper">
    <div id="progress-bar-container">
        <ul>
            <li class="step step01 active"><div class="step-inner">APRIL</div></li>
            <li class="step step02"><div class="step-inner">MEI</div></li>
            <li class="step step03"><div class="step-inner">JUNI</div></li>
            <li class="step step04"><div class="step-inner">JULI</div></li>
            <li class="step step05"><div class="step-inner">AGUSTUS</div></li>
        </ul>
