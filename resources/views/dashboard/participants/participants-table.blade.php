                    ...
                    <form action="/dashboard/email" method="post" id="checkParticipant">
                        ...
                        <tr>
                          ...
                          <td class="action-button text-center d-flex flex-wrap justify-content-evenly align-items-start" style="height:100px;">
                            ...
                            <a href="/dashboard/email/{{$participant->nama_tim}}" class="badge bg-primary"><i class="bi bi-send fs-6"></i></a>  
                            @endif
                            <button type="button" class="badge bg-warning border-0 btn-modal" data-bs-toggle="modal" data-bs-target="#exampleModal" data-team-id="{{ $participant->id }}">
