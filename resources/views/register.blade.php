            ...
            <div class="pt-5 mx-5 md:w-96 pb-10">
                ...
                <form action="" class="w-full justify-center mb-2">
                    <input type="text" name="name" id="name" placeholder="Nama Anda"
                        class="rounded-2xl py-3 px-10 w-full text-black border-none bg-slate-100 mb-5 focus:outline-green-500" />

                    <input type="email" name="email" id="email" placeholder="Email"
                        class="rounded-2xl py-3 px-10 w-full text-black border-none bg-slate-100 mb-5 focus:outline-green-500" />
                    <input type="number" name="nohp" id="nohp" placeholder="No. Handphone"
                        class="rounded-2xl py-3 px-10 w-full text-black border-none bg-slate-100 mb-5 focus:outline-green-500" />
